...
- (id)initForManager:(id)mngr
{
  ...
  if (self)
    ...
    if (appsdict) {
      ...
      /* Ma modification pour un NumericSort qui marche sans ICU*/
      NSInteger SortAsNumbers (id obj1, id obj2, void *context)
      {
	NSInteger n1 = [obj1 intValue];
	NSInteger n2 = [obj2 intValue];		   
	if (n1 > n2) 
	  {
	...
	return (NSComparisonResult)NSOrderedSame;
      ...
      indexes = [indexes sortedArrayUsingFunction: SortAsNumbers context:self];
      /*Fin de modif*/			 
